...
using Havit.SourceGenerators.StrongApiStringLocalizers.Tests.Infrastructure;
...
public class StrongApiStringLocalizersGeneratorTests
{
	...
	public async Task LocalizerGenerator_Test()
	{
		...
		var test = new Microsoft.CodeAnalysis.CSharp.Testing.CSharpSourceGeneratorTest<SourceGeneratorAdapter<StrongApiStringLocalizersGenerator>, Microsoft.CodeAnalysis.Testing.DefaultVerifier>
		{
			TestState =
			{
				AnalyzerConfigFiles =
		...
		// marker file
		test.TestState.GeneratedSources.Add((typeof(SourceGeneratorAdapter<StrongApiStringLocalizersGenerator>), "MyApp.Resources.MyResources.IGlobalLocalizer.g.cs", @"// <auto-generated />
...
"));
		...
		test.TestState.GeneratedSources.Add((typeof(SourceGeneratorAdapter<StrongApiStringLocalizersGenerator>), $"MyApp.Resources.MyResources.GlobalLocalizer.g.cs", @"// <auto-generated />
...
"));
		...
		test.TestState.GeneratedSources.Add((typeof(SourceGeneratorAdapter<StrongApiStringLocalizersGenerator>), "MyApp.Resources.ServiceCollectionExtensions.g.cs", @"// <auto-generated />
