...
namespace Havit.Blazor.Components.Web.Bootstrap
{
	...
	{
		[Parameter] public TValue ValueFrom { get; set; }

		[Parameter] public EventCallback<TValue> ValueFromChanged { get; set; }
		...
		/// </remarks>
		[Parameter] public Expression<Func<TValue>> ValueFromExpression { get; set; }

		[Parameter] public string ValueFromParsingErrorMessage { get; set; }

		[Parameter] public TValue ValueTo { get; set; }

		[Parameter] public EventCallback<TValue> ValueToChanged { get; set; }
		...
		/// The XyExpression property is set internally by the Blazor compiler if you use the @bind﻿ attribute for the Value property to implement two-way binding.
		/// </remarks>
		[Parameter] public Expression<Func<TValue>> ValueToExpression { get; set; }

		[Parameter] public string ValueToParsingErrorMessage { get; set; }

		[Inject] private protected IStringLocalizer<HxDateRangeFilter> StringLocalizer { get; set; }
