...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
		...
		public static ButtonSkin Cancel { get; set; } = new ButtonSkin() { Text = "Cancel", ResourceType = typeof(ButtonSkins), Color = ThemeColor.Secondary };
		public static ButtonSkin Close { get; set; } = new ButtonSkin() { Text = "Close", ResourceType = typeof(ButtonSkins), Color = ThemeColor.Secondary };
		public static ButtonSkin Delete { get; set; } = new ButtonSkin() { Text = "Delete", ResourceType = typeof(ButtonSkins), Color = ThemeColor.Secondary };
		public static ButtonSkin Edit { get; set; } = new ButtonSkin() { Text = "Edit", ResourceType = typeof(ButtonSkins), Color = ThemeColor.Secondary };
		public static ButtonSkin Export { get; set; } = new ButtonSkin() { Text = "Export", ResourceType = typeof(ButtonSkins), Color = ThemeColor.Secondary };
		...
		public static ButtonSkin Open { get; set; } = new ButtonSkin() { Text = "Open", ResourceType = typeof(ButtonSkins), Color = ThemeColor.Secondary };
		public static ButtonSkin Remove { get; set; } = new ButtonSkin() { Text = "Remove", ResourceType = typeof(ButtonSkins), Color = ThemeColor.Secondary };
