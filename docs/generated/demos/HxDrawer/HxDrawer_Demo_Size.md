...
```razor
<HxDrawer @ref="drawerComponent" Title="Title" Size="drawerSize">
    <BodyTemplate>
...
<HxButton OnClick="() => HandleDrawerShow(DrawerSize.Large)" Text="Large drawer" Color="ThemeColor.Primary" />
<HxButton OnClick="() => HandleDrawerShow(DrawerSize.Regular)" Text="Regular drawer" Color="ThemeColor.Primary" />
<HxButton OnClick="() => HandleDrawerShow(DrawerSize.Small)" Text="Small drawer" Color="ThemeColor.Primary" />

@code
{
    private HxDrawer drawerComponent;
    private DrawerSize drawerSize;

    private async Task HandleDrawerShow(DrawerSize size)
    {
        drawerSize = size;
