...
```razor
<HxDrawer @ref="drawerComponent" Title="Title" Backdrop="DrawerBackdrop.Static">
    <BodyTemplate>
...
<HxButton OnClick="() => drawerComponent.ShowAsync()" Text="Show with static backdrop" Color="ThemeColor.Primary" />
