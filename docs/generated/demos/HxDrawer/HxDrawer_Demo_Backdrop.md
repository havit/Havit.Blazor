...
```razor
<HxDrawer @ref="drawerComponent" Title="Title" Backdrop="DrawerBackdrop.False">
    <BodyTemplate>
...
<HxButton OnClick="() => drawerComponent.ShowAsync()" Text="Show with disabled backdrop" Color="ThemeColor.Primary" />
