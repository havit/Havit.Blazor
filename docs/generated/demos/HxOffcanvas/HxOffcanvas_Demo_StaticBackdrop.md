...
```razor
<HxOffcanvas @ref="offcanvasComponent" Title="Title" Backdrop="OffcanvasBackdrop.Static">
    <BodyTemplate>
...
<HxButton OnClick="() => offcanvasComponent.ShowAsync()" Text="Show with static backdrop" Color="ThemeColor.Primary" />
