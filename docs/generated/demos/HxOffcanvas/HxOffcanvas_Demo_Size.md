...
```razor
<HxOffcanvas @ref="offcanvasComponent" Title="Title" Size="offcanvasSize">
    <BodyTemplate>
...
<HxButton OnClick="() => HandleOffcanvasShow(OffcanvasSize.Large)" Text="Large offcanvas" Color="ThemeColor.Primary" />
<HxButton OnClick="() => HandleOffcanvasShow(OffcanvasSize.Regular)" Text="Regular offcanvas" Color="ThemeColor.Primary" />
<HxButton OnClick="() => HandleOffcanvasShow(OffcanvasSize.Small)" Text="Small offcanvas" Color="ThemeColor.Primary" />
