...
```razor
<HxOffcanvas @ref="offcanvasComponent" Title="Title" Backdrop="OffcanvasBackdrop.False">
    <BodyTemplate>
...
<HxButton OnClick="() => offcanvasComponent.ShowAsync()" Text="Show with disabled backdrop" Color="ThemeColor.Primary" />
