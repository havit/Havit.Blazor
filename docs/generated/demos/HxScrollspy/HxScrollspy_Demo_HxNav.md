...
```razor
<HxNav Id="hxnav-example" Variant="NavVariant.Pills">
	<HxScrollspyNavLink Href="#hxnavdemo1">Par 1</HxScrollspyNavLink>
	<HxScrollspyNavLink Href="#hxnavdemo2">Par 2</HxScrollspyNavLink>
	<HxScrollspyNavLink Href="#hxnavdemo3">Par 3</HxScrollspyNavLink>
	<HxScrollspyNavLink Href="#hxnavdemo4">Par 4</HxScrollspyNavLink>
	<HxScrollspyNavLink Href="#hxnavdemo5">Par 5</HxScrollspyNavLink>
</HxNav>

<div style="height:250px;position:relative;">
	<HxScrollspy TargetId="hxnav-example">
		<h4 id="hxnavdemo1">§ 1</h4>
