...
```razor
<HxButton OnClick="() => myDialog.ShowAsync()" Color="ThemeColor.Primary">Launch demo dialog - default scrolling</HxButton>
...
<HxDialog @ref="myDialog" Title="Dialog title">
    ...
    <FooterTemplate>
        <HxButton Text="Close" OnClick="() => myDialog.HideAsync()" Color="ThemeColor.Primary" />
    </FooterTemplate>
</HxDialog>
