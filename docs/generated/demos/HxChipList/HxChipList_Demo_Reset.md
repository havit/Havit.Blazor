...
```razor
<HxChipList Chips="@chips" ShowResetButton="true" ResetButtonText="Reset" OnResetClick="HandleReset" />
...
@code
{
	...
	{
		// use your own logic to reset the chips
		chips = Array.Empty<ChipItem>();
	}
