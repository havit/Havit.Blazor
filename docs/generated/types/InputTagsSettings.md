...
|------|------|-------------|
| Color | `ThemeColor?` | The theme color of the tag chips (applied as a Bootstrap `theme-*` class). |
...
| TagBadgeSettings | `BadgeSettings` | Settings for the `HxBadge` previously used to render tags. |
