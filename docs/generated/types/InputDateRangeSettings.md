...
| PredefinedDateRanges | `IEnumerableInputDateRangePredefinedRangesItem>` | The predefined date ranges to be displayed. Converted internally for DateOnlyRange values. |
