...
public static class SearchIndex
{
	...
	public static IEnumerable<string> GetAllSearchItemTitles()
	{
		return _searchItems.Select(i => i.Title);
	}

	private static readonly List<SearchItem> _searchItems =
	[
		new("/premium", "Premium",
			"support subscription sponsorship price pricing license licensing SLA priority enterprise showcase Goran blocks elements"),
		...
		new("/components/HxDropdown", "HxDropdown",
			"collapse tooltip popover popup popper HxDropdownToggleElement HxDropdownMenu HxDropdownContent HxDropdownHeader HxDropdownItemNavLink HxDropdownItem HxDropdownItemText HxDropdownDivider"),
		new("/components/HxDropdownButtonGroup", "HxDropdownButtonGroup",
			"collapse tooltip popover popup popper HxDropdownToggleButton"),
		...
		new("/components/HxSmartTextArea", "HxSmartTextArea",
			"autocompletions suggest intellisense typeahead ai gpt artificial intelligence"),
		new("/components/HxSmartComboBox", "HxSmartComboBox",
			"autocomplete search typeahead select suggest ai artificial intelligence autosuggest"),
		...
		new("/types/MessengerServiceExtensionsSettings", "MessengerServiceExtensions Settings", "defaults",
			DefaultsLevel),
		...
		new("/types/AnchorFragmentNavigationAutomationMode", "AnchorFragmentNavigationAutomationMode", "enum",
			EnumsLevel),
		...
		new("/types/CalendarDateCustomizationProviderDelegate", "CalendarDateCustomizationProviderDelegate",
			"delegate action", DelegatesLevel),
		...
		new("/types/AutosuggestDataProviderDelegate", "AutosuggestDataProviderDelegate", "delegate action",
			DelegatesLevel),
