...
/// <summary>
/// Provides the documentation catalog built from a static list of all documented pages.
/// </summary>
public class DocumentationCatalogService : IDocumentationCatalogService
{
	...
	private static readonly IReadOnlyList<DocumentationCatalogItem> s_allItems = new List<DocumentationCatalogItem>
	{
		...
		new("/components/HxButtonGroup", "HxButtonGroup", "collection toggles checkbox"),
		...
		new("/components/HxCheckbox", "HxCheckbox", "hxinputcheckbox switch toggle"),
		new("/components/HxCheckboxList", "HxCheckboxList", "multiselect toggles switchlist buttongroup"),
		...
		new("/components/HxDialog", "HxDialog", "popup fullscreen modal messagebox"),
		new("/components/HxDialogBase", "HxDialogBase", "custom dialog modal messagebox"),
		new("/components/HxDrawer", "HxDrawer", "offcanvas"),
		...
		new("/components/HxInputFile", "HxInputFile", "upload single multiple"),
		new("/components/HxInputFileCore", "HxInputFileCore", "upload single multiple"),
		new("/components/HxInputFileDropZone", "HxInputFileDropZone", "upload single multiple drag and drop"),
		...
		new("/components/HxMenu", "HxMenu", "dropdown collapse tooltip popover popup HxMenuToggleButton HxMenuToggleElement HxMenuItem HxMenuItemNavLink HxMenuText HxMenuHeader HxMenuDivider"),
		...
		new("/components/HxNavOverflow", "HxNavOverflow", "priority plus navigation responsive more overflow menu"),
		new("/components/HxNavbar", "HxNavbar", "navigation header"),
		new("/components/HxOtpInput", "HxOtpInput", "otp one-time password pin verification code 2fa mfa authentication digits"),
		...
		new("/types/DrawerSettings", "Drawer Settings", "defaults offcanvas", DefaultsLevel),
		...
		new("/types/Dialog Settings", "Dialog Settings", "defaults", DefaultsLevel),
		...
		new("/types/NavOverflowSettings", "NavOverflow Settings", "defaults", DefaultsLevel),
		new("/types/OtpInputSettings", "OtpInput Settings", "defaults", DefaultsLevel),
		...
		new("/types/DrawerRenderMode", "DrawerRenderMode", "enum offcanvas", EnumsLevel),
		new("/types/DrawerResponsiveBreakpoint", "DrawerResponsiveBreakpoint", "enum offcanvas", EnumsLevel),
		new("/types/DrawerSize", "DrawerSize", "enum offcanvas", EnumsLevel),
		...
		new("/types/MenuAutoClose", "MenuAutoClose", "enum dropdown", EnumsLevel),
		new("/types/MenuPlacement", "MenuPlacement", "enum dropdown", EnumsLevel),
		new("/types/DialogAnimation", "DialogAnimation", "enum fade slide", EnumsLevel),
		new("/types/DialogBackdrop", "DialogBackdrop", "enum static", EnumsLevel),
		new("/types/DialogFullscreen", "DialogFullscreen", "enum behavior", EnumsLevel),
		new("/types/DialogSize", "DialogSize", "enum", EnumsLevel),
		...
		new("/types/NavOverflowIconPlacement", "NavOverflowIconPlacement", "enum", EnumsLevel),
	...
	private static readonly IReadOnlyList<DocumentationCatalogItem> s_components = s_allItems
		.Where(item => item.Title.StartsWith("Hx", StringComparison.Ordinal) && item.Level == 0)
		.ToList();

	/// <inheritdoc />
	public IReadOnlyList<DocumentationCatalogItem> GetAll() => s_allItems;

	/// <inheritdoc />
	public IReadOnlyList<DocumentationCatalogItem> GetComponents() => s_components;
}
